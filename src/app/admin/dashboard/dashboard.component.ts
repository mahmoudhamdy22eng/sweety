...
export class DashboardComponent {
  ...
  currentSection: string = 'stores'; // Default to 'stores' section
...
// dogs
  togglePetDog(pet_id: number) {
    ...
    category =[{name:"stores",route:'stores'},{name:"clinics",route:'clinics'},{name:"owners",route:'owners'},
                {name:"cats",route:'cats'},{name:"dogs",route:'dogs'}];
