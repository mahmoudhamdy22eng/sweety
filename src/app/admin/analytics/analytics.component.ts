...
export class AnalyticsComponent {
  ...
  currentSection: string = 'orders'; // Default to 'stores' section
...
// dogs
  togglePetDog(pet_id: number) {
    ...
    category =[{name:"orders",route:'orders'},{name:"payments",route:'payments'},
                {name:"shipping",route:'shipping'},{name:"wishlists",route:'wishlists'}];
