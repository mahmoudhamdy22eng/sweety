...
export class ManageUsersComponent {
  ...
  currentSection: string = 'admins'; // Default to 'stores' section
...
// dogs
  togglePetDog(pet_id: number) {
    ...
    category =[{name:"Admins",route:'admins'},{name:"Suppliers",route:'suppliers'},
                {name:"Customers",route:'customers'}];
                // {name:"category4",route:'cats'},{name:"category5",route:'dogs'}];
