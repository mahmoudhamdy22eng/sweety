...
@Component({
  selector: 'app-newsnack',
  templateUrl: './newsnack.component.html',
  styleUrls: ['./newsnack.component.css']
})
export class NewsnackComponent {
  ...
  product: Product = {
    ...
    price: 0,
    QuantityAvailable: 0,
    CategoryID: "2", // Assuming 2 is the ID for snacks category
    AdminID: '1',
  ...
  addProduct() {
    ...
    this.apiService.addSnack(formData)
      .subscribe(response => {
